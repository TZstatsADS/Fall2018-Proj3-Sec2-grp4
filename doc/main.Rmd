...
```{r wkdir, eval=FALSE}
set.seed(2018)
setwd("C:/Users/User/Desktop/Fall2018-Proj3-Sec2-grp4/doc") 
...
## Test By Hand
```{r}
imgLRkk <- readImage(paste0(test_LR_dir,  "img", "_", sprintf("%04d", 1), ".jpg"))
```
```{r}
dim(imgLRkk)
```
...
```{r}
display(HRimg, method="raster", all=TRUE)
```
